...
<Dialog.Root bind:open {onOpenChange}>
        <Dialog.Content class="@container z-9999 !max-h-[80dvh] !max-w-[60rem] max-w-full">
                ...
                <Dialog.Header>
                        <Dialog.Title>模型信息</Dialog.Title>

                        <Dialog.Description>当前模型详情与功能</Dialog.Description>
                </Dialog.Header>

                <div class="space-y-6 py-4">
                        {#if isLoadingModels || isLoadingRouterProps}
                                <div class="flex items-center justify-center py-8">
                                        <div class="text-sm text-muted-foreground">加载模型信息中...</div>
                                </div>
                        {:else if firstModel}
                                ...
                                {#if serverProps}
                                        <Table.Root>
                                                <Table.Header>
                                                        <Table.Row>
                                                                <Table.Head class="w-[10rem]">模型</Table.Head>
                                                ...
                                                <Table.Body>
                                                        <!-- Model Path -->
                                                        <Table.Row>
                                                                <Table.Cell class="h-10 align-middle font-medium">文件路径</Table.Cell>
                                                        ...
                                                        {#if serverProps?.default_generation_settings?.n_ctx}
                                                                <Table.Row>
                                                                        <Table.Cell class="h-10 align-middle font-medium">上下文大小</Table.Cell>
                                                        ...
                                                        {:else}
                                                                <Table.Row>
                                                                        ...
                                                                        <Table.Cell class="text-red-500">不可用</Table.Cell>
                                                                </Table.Row>
                                                        {/if}
                                                        ...
                                                        {#if modelMeta?.n_ctx_train}
                                                                <Table.Row>
                                                                        <Table.Cell class="h-10 align-middle font-medium">训练上下文</Table.Cell>
                                                        ...
                                                        {#if modelMeta?.size}
                                                                <Table.Row>
                                                                        <Table.Cell class="h-10 align-middle font-medium">模型大小</Table.Cell>
                                                        ...
                                                        {#if modelMeta?.n_params}
                                                                <Table.Row>
                                                                        <Table.Cell class="h-10 align-middle font-medium">参数量</Table.Cell>
                                                        ...
                                                        {#if modelMeta?.n_embd}
                                                                <Table.Row>
                                                                        <Table.Cell class="align-middle font-medium">嵌入维度</Table.Cell>
                                                        ...
                                                        {#if modelMeta?.n_vocab}
                                                                <Table.Row>
                                                                        <Table.Cell class="align-middle font-medium">词表大小</Table.Cell>
                                                        ...
                                                        {#if modelMeta?.vocab_type}
                                                                <Table.Row>
                                                                        <Table.Cell class="align-middle font-medium">词表类型</Table.Cell>
                                                        ...
                                                        <!-- Total Slots -->
                                                        <Table.Row>
                                                                <Table.Cell class="align-middle font-medium">并行槽位</Table.Cell>
                                                        ...
                                                        {#if modalities.length > 0}
                                                                <Table.Row>
                                                                        <Table.Cell class="align-middle font-medium">支持模态</Table.Cell>
                                                        ...
                                                        <!-- Build Info -->
                                                        <Table.Row>
                                                                <Table.Cell class="align-middle font-medium">构建信息</Table.Cell>
                                                        ...
                                                        {#if serverProps.chat_template}
                                                                <Table.Row>
                                                                        <Table.Cell class="align-middle font-medium">对话模板</Table.Cell>
                        ...
                        {:else if !isLoadingModels}
                                <div class="flex items-center justify-center py-8">
                                        <div class="text-sm text-muted-foreground">无模型信息</div>
                                </div>
                        {/if}
                </div>
        </Dialog.Content>
